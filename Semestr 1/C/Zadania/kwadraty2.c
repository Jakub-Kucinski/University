...
//Funkcja wylicza pierwszy kwadrat magiczny o boku 5 w około 5 sekund, 10 takich kwadratów w około 50 sekund
...
void magiczne(int n, int * ile)
{
    ...
    kwadratytest2(n*n, 0, p, t, ((n*n+1)*n)/2, n, kolumna, wiersz, ile);
...
{
    int n;
    scanf("%d", &n);//wczytywanie jakiej dlugosci bok ma miec kwadrat magiczny
    int ile=0;
