...
(define split-tests
  (test-suite
   ...
   (test-case
    ...
    (check-equal? (split (list 1 2)) (cons (list 1) (list 2)) "Blad 2"))
   (test-case
    "Odd number of elements in list"
    (check-equal? (split (list 1 2 3)) (cons (list 1) (list 2 3)) "Blad 3")
    (check-equal? (split (list 5 4 3 2 1)) (cons (list 5 4) (list 3 2 1)) "Blad 4"))
   (test-case
    "One element lists and empty lists"
    (check-equal? (split (list 1)) (cons (list) (list 1)) "Blad 5")
    (check-equal? (split (list)) (cons (list) (list)) "Blad 6"))
   ))
